...
the out-of-sample prediction of the gated correlation) exist because referee-grade objections
...
\section{A coherence-gated horizon--gluon correlation}\label{sec:law}
...
reproduction yet; the gated correlation's continuum fate and its SU(3) counterpart are open.
...
dated in place) are available at \url{https://github.com/hooamaai-create/su2-orbit-space} and permanently archived at \href{https://doi.org/10.5281/zenodo.21993866}{doi:10.5281/zenodo.21993866} (concept DOI, resolving to the latest archived version); a reading guide maps the entries that
